 ...
 * generates alongside each case-study JPEG. Exported so CaseStudyGallery
 * can build the identical srcset when preloading off-screen slides. */
const WEBP_WIDTHS = [480, 900, 1300];

export const CASE_STUDY_IMAGE_SIZES = "(max-width: 48rem) 100vw, 53vw";
